...
//         .verifyTitle();
        ...
        String actualText = driver.findElement(By.className("de1")).getText();
        String expectedText="git config --global user.name  \"New Sheriff in Town\"\ngit reset $(git commit-tree HEAD^{tree} -m \"Legacy code\")\ngit push origin master --force";

        String actualColor = driver.findElement(By.xpath("//*[@class='de1']/*[@class='kw2'])[1]")).getCssValue("color");
        String expectedColor="#c20cb9";
